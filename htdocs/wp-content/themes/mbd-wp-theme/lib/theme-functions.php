...
function mbdmaster324_scripts() {
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'mbdmaster324_headroom', get_template_directory_uri() . '/assets/js/source/vendor/headroom.min.js', array(), '', TRUE );
		...
		if ( is_front_page() ) {
			...
			wp_enqueue_script( 'mbdmaster324_typer', get_template_directory_uri() . '/assets/js/source/vendor/jquery.typer.js', array(), '', TRUE );
		}
