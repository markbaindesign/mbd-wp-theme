...
<?php
	...
	$wp_customize->add_section( 'mbdmaster_archives_section', array(
	    ...
	    'priority'    => 30,
	    'description' => 'Customize the automatically-generated archive pages.',
 	));

	// Settings
 	$wp_customize->add_setting( 'mbdmaster_default_archive_image' );
 	$wp_customize->add_setting( 'mbdmaster_work_archive_image' );
 	$wp_customize->add_setting( 'mbdmaster_work_archive_title' );
 	$wp_customize->add_setting( 'mbdmaster_work_archive_content' );
 	...
 	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mbdmaster_work_archive_image', array(
	    'label'    => __( 'Work Archive Cover Image', 'mbdmaster' ),
	    'section'  => 'mbdmaster_archives_section',
	    'settings' => 'mbdmaster_work_archive_image',
	 )));
	$wp_customize->add_control( new MBD_Customize_Textarea_Control( 
		$wp_customize, 
		'mbdmaster_work_archive_content', 
		array(
	 	    'label'    => __( 'Work Archive Intro Content', 'mbdmaster' ),
	 	    'section'  => 'mbdmaster_archives_section',
	 	    'settings' => 'mbdmaster_work_archive_content',
 	 	)
 	));
	$wp_customize->add_control( new MBD_Customize_Textarea_Control( 
		$wp_customize, 
		'mbdmaster_work_archive_title', 
		array(
	 	    'label'    => __( 'Work Archive Title', 'mbdmaster' ),
	 	    'section'  => 'mbdmaster_archives_section',
