...
require get_template_directory() . '/functions/framework/inc/template-tags/show-all-terms.php';
require get_template_directory() . '/functions/framework/inc/template-tags/social-sharing.php';