...
require get_template_directory() . '/framework/inc/header/search-bar.php';
require get_template_directory() . '/framework/inc/header/toggle--menu.php';
require get_template_directory() . '/framework/inc/header/toggle--search.php';